...
metadata. Metadata should only be retrieved at the course and lecture level
through two core functions:
- ~org-lectures-index-get-course-list~
- ~org-lectures-index-get-course-lectures-list~
...
~org-lectures-index-get-course-lectures-list~ gets called for that course.

*What functions should be used outside of this module?* Under the usual
convention, no function with the prefix ~org-lectures-index--~ should ever be used
outside this module. They are to be considered "internal" functions, and as such
...
#+RESULTS: Org-parse
: org-lectures-index--parse-org-file
...
: org-lectures-index-parse-course-file
...
: org-lectures-index-get-course-dir
